const aboutDesc = [
  ...
  {
    id: 3,
    ID: `Dalam website ini saya akan menulis beberapa blog dan menampilkan saya proyek. Saya percaya bahwa menulis apa yang telah saya pelajari adalah yang terbaik cara untuk mengingat hal-hal, dan saya bisa berbagi pengetahuan saya sepanjang jalan. Jadi hubungi saya dan saya akan dengan senang hati membantu!`,
    EN: `In this website I will be writing some blogs and showcase my projects. I believe that writing what I have learned is the best way to remember things, and I can share my knowledge along the
